...
const WIN_TYPES = [
  ...
  { value: 'dq',          label: 'Disqualification',  short: 'DQ'  },
];
      ...
      <div className="flex flex-1 min-h-0">
        ...
        <div className="flex-1 flex flex-col relative overflow-hidden">
          ...
          <div className="flex-1 flex items-center justify-center relative">
            <div className="text-[140px] font-black leading-none text-red-400 tabular-nums drop-shadow-2xl">
              {scoreRed}
            </div>
          </div>
        ...
        <div className="w-56 flex flex-col items-center justify-between py-6 bg-[#080808] border-x border-white/[0.06] shrink-0">
          ...
          <div className="text-center w-full px-4">
            <div className={`text-6xl font-black font-mono tabular-nums tracking-tighter transition-colors ${
        ...
        <div className="flex-1 flex flex-col relative overflow-hidden">
          ...
          {/* Score */}
          <div className="flex-1 flex items-center justify-center relative">
            <div className="text-[140px] font-black leading-none text-blue-400 tabular-nums drop-shadow-2xl">
              {scoreBlue}
            </div>
          </div>
